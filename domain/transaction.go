...
const (
	TransactionStateInitiated  = "initiated"
	TransactionStateProcessing = "processing"
...
type Transaction struct {
	...
	Status          string    `json:"status" validate:"required,oneof=initiated processing success failed"`
